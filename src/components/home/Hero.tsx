...
const Hero = () => {
  return (
    <section className="relative h-[90vh] min-h-[700px] bg-gradient-to-r from-fashion-black to-gray-800 flex items-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 z-10 text-white">
        <ParallaxEffect speed={0.4} direction="down">
          <div className="max-w-2xl">
            ...
            <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight animate-fade-in opacity-0" style={{animationDelay: '0.2s', animationFillMode: 'forwards'}}>
              New Summer <br/>
              <span className="text-fashion-accent">Collection</span>
            </h1>
            <p className="text-xl mb-10 opacity-80 animate-fade-in opacity-0" style={{animationDelay: '0.4s', animationFillMode: 'forwards'}}>
              Discover the latest trends for the upcoming season
            </p>
            <div className="flex flex-col sm:flex-row gap-5 animate-fade-in opacity-0" style={{animationDelay: '0.6s', animationFillMode: 'forwards'}}>
              <Link to="/category/women" className="bg-white text-fashion-black px-8 py-4 font-medium hover:bg-opacity-90 transition-colors text-center hover:scale-105 transition-transform">
                Shop Women
              </Link>
              <Link to="/category/men" className="border border-white text-white px-8 py-4 font-medium hover:bg-white hover:text-fashion-black transition-colors text-center hover:scale-105 transition-transform">
                Shop Men
              </Link>
            </div>
          </div>
